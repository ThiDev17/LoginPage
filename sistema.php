...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #0f0099;">
    ...
    <div class="box-search">
        <input type="search" class="form-contro w-25" placeholder="Pesquisar" id="pesquisar">
